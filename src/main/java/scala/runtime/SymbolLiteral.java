...
public final class SymbolLiteral {
    ...
    public static CallSite bootstrap(MethodHandles.Lookup lookup, String invokedName,
        ...
        MethodType type = MethodType.fromMethodDescriptorString("(Ljava/lang/String;)Lio/github/iltotore/spongescala/library/Symbol;", classLoader);
        Class<?> symbolClass = Class.forName("io.github.iltotore.spongescala.library.Symbol", false, classLoader);
